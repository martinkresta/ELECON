...
static void InitPcScanList(void)
{
  ...
  UpdateScanList(VAR_SOLAR_ENERGY_TODAY_10WH, 3000);
	...
	UpdateScanList(VAR_STRG1_SOC, 2000);
	UpdateScanList(VAR_STRG1_POWER_W, 2000);
	UpdateScanList(VAR_STRG1_CURRENT_A10, 2000);
	UpdateScanList(VAR_STRG1_ENERGY_WH, 2000);
	UpdateScanList(VAR_STRG1_OPT_CHARGING_A, 2000);
	UpdateScanList(VAR_STRG1_CAPACITY_AH, 2000);
	UpdateScanList(VAR_STRG1_BALANCED_TODAY, 2000);
	UpdateScanList(VAR_STRG1_VOLTAGE_V10, 2000);
	UpdateScanList(VAR_LLOAD1_POWER_W, 2000);
	UpdateScanList(VAR_LLOAD1_CONS_WH, 2000);
	UpdateScanList(VAR_LPV1_POWER_W, 2000);
	UpdateScanList(VAR_LPV1_PROD_WH, 2000);
	UpdateScanList(VAR_LPV1_S1_POWER_W, 2000);
	UpdateScanList(VAR_LPV1_S1_CURRENT_A10, 2000);
	UpdateScanList(VAR_LPV1_S1_VOLTAGE_V, 2000);
	UpdateScanList(VAR_LPV1_S2_POWER_W, 2000);
	UpdateScanList(VAR_LPV1_S2_CURRENT_A10, 2000);
	UpdateScanList(VAR_LPV1_S2_VOLTAGE_V, 2000);


	UpdateScanList(VAR_STRG2_SOC, 2000);
	UpdateScanList(VAR_STRG2_POWER_W, 2000);
	UpdateScanList(VAR_STRG2_CURRENT_A10, 2000);
	UpdateScanList(VAR_STRG2_ENERGY_WH, 2000);
	UpdateScanList(VAR_STRG2_OPT_CHARGING_A, 2000);
	UpdateScanList(VAR_STRG2_CAPACITY_AH, 2000);
	UpdateScanList(VAR_STRG2_BALANCED_TODAY, 2000);
	UpdateScanList(VAR_STRG2_VOLTAGE_V10, 2000);
	UpdateScanList(VAR_LLOAD2_POWER_W, 2000);
	UpdateScanList(VAR_LLOAD2_CONS_WH, 2000);
	UpdateScanList(VAR_LPV2_POWER_W, 2000);
	UpdateScanList(VAR_LPV2_PROD_WH, 2000);
	UpdateScanList(VAR_LPV2_S1_POWER_W, 2000);
	UpdateScanList(VAR_LPV2_S1_CURRENT_A20, 2000);
	UpdateScanList(VAR_LPV2_S1_VOLTAGE_V, 2000);
	UpdateScanList(VAR_LPV2_S2_POWER_W, 2000);
	UpdateScanList(VAR_LPV2_S2_CURRENT_A20, 2000);
	UpdateScanList(VAR_LPV2_S2_VOLTAGE_V, 2000);


	UpdateScanList(VAR_LVDC_VDIFF_V100, 2000);
	UpdateScanList(VAR_LVDC_VDIFF_MAX, 2000);
	UpdateScanList(VAR_LVDC_CURRENT_A, 2000);
	UpdateScanList(VAR_LVDC_LOSS_W, 2000);
	UpdateScanList(VAR_LVDC_LOSS_CONS_WH, 2000);
